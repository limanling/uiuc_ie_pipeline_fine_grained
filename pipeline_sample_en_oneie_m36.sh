...
event_corefer_time=${data_root}/event/dry_run_event_with_time.cs  #${event_result_dir}/events_corefer_timefix.cs
...
# docker run --rm -i -v ${data_root}:${data_root} -w /oneie limteng/oneie_aida \
#     /opt/conda/bin/python \
#     /oneie/predict.py ${ltf_source} ${data_root} english 20 100 5 1 1
...
# docker run --rm -v ${data_root}:${data_root} -v ${data_root}:${data_root} -w `pwd`  -i limanling/uiuc_ie_m18 \
#     /opt/conda/envs/py36/bin/python \
