...
event_corefer_time=${event_result_dir}/dry_run_event_with_time.cs  #events_corefer_timefix.cs  # 
...
# ###### add haoyang's
# ###### whether converter will report errors after adding haoyang's 4-tuple??
# ######################
